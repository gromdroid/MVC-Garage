...
public class Model extends java.util.Observable {	
    ...
    static double weekDayArrivals= 190; // average number of arriving cars per hour
    static double weekendArrivals = 190; // average number of arriving cars per hour
    static double weekDayPassArrivals= 30; // average number of arriving cars per hour
    static double weekendPassArrivals = 30; // average number of arriving cars per hour
    static double weekDayElectricArrivals= 20; //average number of electric cars per hour
    static double weekendElectricArrivals= 20; //average number of electric cars per hour
    static double weekDayPassElectricArrivals= 18; //average number of electric cars per hour
    static double weekendPassElectricArrivals= 20; //average number of electric cars per hour
    
    static int weekDayPreservedArrivals= 20; //average number of electric cars per hour
    static int weekendPreservedArrivals= 20; //average number of electric cars per hour
    ...
    private static void advanceTime(){
        ...
        while (minute > 59) {
            ...
            View.normalCarSet.add((double) hourGraph, (double) totalCarsParkingN);
            View.passCarSet.add((double) hourGraph, (double) totalCarsParkingP);
            View.electricCarSet.add((double) hourGraph, (double) totalCarsParkingE);
            View.electricPassCarSet.add((double) hourGraph, (double) totalCarsParkingPE);
            View.preservedCarSet.add((double) hourGraph, (double) totalCarsParkingR);
    ...
    public static void updateViews(){
    	if(!pauseState){
            ...
            int totalFreeSpots = 540 - (totalCarsParkingN + totalCarsParkingP + totalCarsParkingE + totalCarsParkingPE + totalCarsParkingR);
            ...
            int totalQueue = (entrancePassQueue.carsInQueue() + entranceCarQueue.carsInQueue() + entranceElectricQueue.carsInQueue() + entrancePassElectricQueue.carsInQueue() + entrancePreservedQueue.carsInQueue());
            time = timeHour + ":" + timeMinute;
            View.totalLabel.setText("<html>Total amount of cars parked: " + String.valueOf(totalCarsParkingE + totalCarsParkingN + totalCarsParkingP + totalCarsParkingPE + totalCarsParkingR) + "<br> "
            		+ "Total amount of cars in queue: " + String.valueOf(totalQueue) + "<br> "
                    ...
                    + "Estimated money to gain today €" + String.valueOf(Math.round(((totalCarsParkingN + totalCarsParkingE) * 2.40) * 100.0) / 100.0) + "0<br>"
            		+ "Time passed: " + time + "<br> "
